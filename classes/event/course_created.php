...
class course_created extends \core\event\base
{
    ...
    {
        return get_string('approverequest_New', 'block_ckc_requests_manager');
    ...
    {
        return "user {$this->userid} :".$this->other.' '.get_string('createdsuccess', 'block_ckc_requests_manager');
