...
// block_ckc_requests_manager_config.php
...
// GDPR Privacy API
$string['comments'] = 'Comments';
$string['privacy:metadata:db:block_ckc_requests_manager_records:modname']      = 'The requested course full name';
$string['privacy:metadata:db:block_ckc_requests_manager_records:modcode']      = 'The requested course short name';
$string['privacy:metadata:db:block_ckc_requests_manager_records:createdbyid']  = 'The user ID submitting the request';
$string['privacy:metadata:db:block_ckc_requests_manager_records:createdate']   = 'Time created';
$string['privacy:metadata:db:block_ckc_requests_manager_records']              = 'Stores requests for the course request manager block';
$string['privacy:metadata:db:block_ckc_requests_manager_comments:instanceid']  = 'The request ID that the comment refers to';
$string['privacy:metadata:db:block_ckc_requests_manager_comments:createdbyid'] = 'The user ID submitting the comment';
$string['privacy:metadata:db:block_ckc_requests_manager_comments:dt']          = 'Time created';
$string['privacy:metadata:db:block_ckc_requests_manager_comments:message']     = 'The comment message';
$string['privacy:metadata:db:block_ckc_requests_manager_comments']             = 'Stores comments regarding courses requests for the course request manager block';
