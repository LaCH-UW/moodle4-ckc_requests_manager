...
// $configHasRun =  get_record('block_ckc_requests_manager_config', 'varname', 'confighasrun');
$configHasRun = $GLOBALS['DB']->get_field('block_ckc_requests_manager_config', 'value', ['varname' => 'confighasrun']);
...
if ($configHasRun == '' || $configHasRun == null) {
    ...
    $newrec->value   = time(['d' => date('d'), 'M' => date('n'), 'Y' => date('Y')]);
    $GLOBALS['DB']->insert_record('block_ckc_requests_manager_config', $newrec, false);
